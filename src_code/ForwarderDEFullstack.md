# ForwarderDEFullstack Git History
...
- Latest commit: `2026-08-07T22:49:47+05:30`
- Active commit dates: **6**
...
The project was initialized and migrated to SvelteKit and FastAPI in July. Most July work implemented AI intake and broker negotiation, bidding, trip management, authentication, role-based access, tracking, and deployment infrastructure. August shifted deployment from Vercel to Railway and updated build and Prisma configuration.
...
| `ae83892` | `2026-07-11T23:55:37+05:30` | pbk0@NUC | feat: add workspace configuration for project structure and reference implementation |
| `db9025c` | `2026-08-07T22:12:23+05:30` | Fahad khan | removed : dumped vercel shift towards railway |
| `55a5a8b` | `2026-08-07T22:30:32+05:30` | Fahad khan | ADD: build cmd |
| `77cac09` | `2026-08-07T22:49:47+05:30` | Fahad khan | prisma changes |